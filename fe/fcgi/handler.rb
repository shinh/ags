...
class Handler
  ...
  def file_types
    [
     ...
     'ly','io','js','lua','tcl','xtal',
     'kt','sno','icn','rexx','gp','cy',
     'st', 'pro','for','bas',
     'pl6', 'erl', 'ijs', 'a+', 'k', 'mind',
     'c','cpp','d','go',
     'ml',
     'hs','adb','m','java','pas','f95','cs','n','cob','curry','lmn','max','oct','reb','asy','exu',
     'awk','sed','sh','zsh','fish','wake','bc','dc',
     'xgawk','m4','ps','r','vhdl','qcl',
     'bf','ws','bef', 'pef', 'ms', 'gs', 'flog', 'nand','clci','mal',
  ...
  def file_langs
    [
     ...
     'LilyPond','Io','JavaScript','Lua','Tcl','Xtal',
     'Kite','SNOBOL','Icon','REXX','PARI/GP','Cyan',
     'Smalltalk', 'Prolog','Forth','BASIC',
     'Perl6', 'Erlang', 'J', 'A+', 'K', 'Mind',
     'C','C++','D','Go',
     'OCaml',
     'Haskell',
     'Ada','ObjC','Java','Pascal','Fortran','C#','Nemerle','COBOL','Curry','LMNtal','Maxima','Octave','REBOL','Asymptote','Euphoria',
     'AWK','sed','Bash','Zsh','fish','wake','bc','dc',
     'xgawk','m4','Postscript','R','VHDL','QCL',
     'Brainfuck','Whitespace','Befunge','Pefunge','Minus','GolfScript', 'FlogScript', 'FerNANDo','CLC-INTERCAL','Malbolge',
