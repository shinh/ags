...
class Handler
  ...
  def file_types
    [
     'rb','pl','py','py3','php','pike','scm','l','arc','clj',
     ...
     'bf','ws','bef', 'bef98', 'pef', 'ms', 'gs', 'flog', 'blsq', 'nand','clci','mal',
  ...
  def file_langs
    [
     'Ruby','Perl','Python','Python3','PHP','Pike','Scheme',
     ...
     'Brainfuck','Whitespace','Befunge','Befunge-98','Pefunge','Minus','GolfScript', 'FlogScript', 'Burlesque', 'FerNANDo','CLC-INTERCAL','Malbolge',
